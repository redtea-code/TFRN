...
if __name__ == '__main__':
    ...
    copytree(configs_path, configs_saving)#复制cofig文件
    ...
    # Dataset
    DS = DatasetFactory.get_dataset_type(use_future_fea, use_static,dataset=dataset,decompose=decompose)
    ...
    with open(saving_root / "y_stds_dict.pkl", "wb") as f:
        pickle.dump(y_stds_dict, f)
